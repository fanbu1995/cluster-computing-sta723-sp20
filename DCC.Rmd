...
- `common`: default partition; jobs directed to core nodes with up to 64 GB RAM.
...
Being a member of `statdept`, you have priority to run jobs on the following nodes:
